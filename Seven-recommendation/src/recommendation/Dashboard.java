...
import static recommendation.UserGraphStructure.initiateGraph;
...
//        // Create a new JLabel
//      JLabel newLabel = new JLabel("Hello user "+userID+" !"); 
...
private void followUser(int followerId, String followeeUsername) {
    ...
    try {
        ...
        // Optionally, you can update any graphical representation of the network here
...
//private void createPost(String content, int categoryID) {
//    Connection conn = dbConnection.dbconnect();
//    
//    try {
...
//                
//
//                Object[] obj = {PostID,enter_username, Content,likes, categoryID};
...
//public void setRecordsToTable(JTable Tablee, int categoryID) {
//    try {
//        Connection con = dbConnection.dbconnect();
//        PreparedStatement pst = con.prepareStatement("SELECT p.post_id, u.UserName, p.content, p.like_count " +
//                                                      "FROM Posts p " +
...
public void setRecordsToTable(JTable Tablee) {
    ...
    try {
        ...
        // Modify the query to retrieve posts based on user's selected categories
        // and posts made by users the current user is following
